...
```
twelvedata <command> [arguments] [flags]
```

Run `twelvedata <command> --help` for the full flag list on any command. This
...
per operation you declare in `twelvedata/domain.go`.

...
Most of these come down to network reality or how twelvedata serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

twelvedata rate-limits like any public site. twelvedata already paces
...
Where a surface is gated, twelvedata reads a cookie or token you supply
...
`twelvedata`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what twelvedata actually did

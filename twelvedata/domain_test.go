...
// HTTP behaviour is covered in twelvedata_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "twelvedata://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("twelvedata", "about")
	if err != nil || got.String() != "twelvedata://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want twelvedata://page/about", got.String(), err)
	}
}
